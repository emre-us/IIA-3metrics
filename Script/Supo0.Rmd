...
## OLS Estimator in Single Regression
...
We obtained the expressions for $\widehat{\beta}_0$ and $\widehat{\beta}_1$ in Section 1 above under the OLS discussion. Lets replicate them here for convenience:
\[
...
The [Unbiased Estimator](#ue) section establishes that $\widehat{beta}_0$ and $\widehat{\beta}_1$ are unbiased estimators.  
