...
Thus, testing $\mathbb{H}_0: log(\mathbb{E}(wage)) = \mu_0$ is not equivalent to testing $\mathbb{H}_0: \mathbb{E}(log(wage)) = \mu_0$. By the same logic, testing $\mathbb{H}_0: \bar D = 0$ is not equivalent to testing $\mathbb{H}_0: \overset{\sim}{D}=0$.
